...
@else --}}
<form action="{{ url('/sertifikasi/' . $sertifikasi->id_sertifikasi . '/store_rekomendasi_peserta') }}" method="POST"
    ...
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Rekomendasi Peserta Sertifikasi</h5>
