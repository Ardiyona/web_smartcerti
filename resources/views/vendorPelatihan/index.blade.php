    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button onclick="modalAction(`{{ url('/vendorpelatihan/import') }}`)" class="btn btn-success"
                    style="background-color: #EF5428; border-color: #EF5428;"><i class="fas fa-file-import"></i>
                    Import</button>
                <button onclick="modalAction(`{{ url('/vendorpelatihan/create') }}`)" class="btn btn-success"
        ...
        <div class="card-body">
            ...
            @endif
            <table class="table responsive table-bordered table-striped table-hover table-sm" id="table_vendor_pelatihan">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nama</th>
