...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card-header text-center">
            ...
            <a href="{{ url('/') }}" class="h1" style="color: #EF5428;"><b>SMARTCERTI</b></a>
        </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ url('login') }}" method="POST" id="form-login">
                    ...
                    <div class="row">
                        ...
                        <!-- /.col -->
                        <div class="col-4">
                            <button type="submit" class="btn btn-block btn-custom">Sign In</button>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#form-login").validate({
                ...
                submitHandler: function(form) { // when valid, this section runs
                    $.ajax({
                        url: form.action,
                        type: form.method,
                        data: $(form).serialize(),
