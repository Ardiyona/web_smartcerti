<form action="{{ url('/bidangminat/import_ajax') }}" method="POST" id="form-import-bidangminat" enctype="multipart/form-data">
    @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_bidang_minat.xlsx') }}" class="btn" style="color: white; background-color: #375E97; border-color: #375E97;">
...
<script>
    $(document).ready(function() {
        $("#form-import-bidangminat").validate({
            rules: {
                file_bidang_minat: {
                    required: true,
                    extension: "xlsx"
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) { // Jika sukses
                            ...
                            tableBidangMinat.ajax.reload(); // Reload datatable bidang minat
                        } else { // Jika error
                            $('.error-text').text('');
